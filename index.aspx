            ...
            <div class="container">
                <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
                  <a href="" class="navbar-brand p-0">
                    <h1 class="text-primary m-0">REGISTER</h1>
                        ...
                        <div class="wow fadeInUp" data-wow-delay="0.2s">
                            <form >
                                <div class="row g-3" >
                                    ...
                                    <br />
                                    <div class="col-7" style="margin:auto">
                                         <asp:TextBox ID="TextBox3" runat="server" class="form-control" placeholder="Email" type="email" required="required"></asp:TextBox>
                                        <br />
                                    </div>
                                    <br />
                                    <div class="col-7" style="margin:auto">
