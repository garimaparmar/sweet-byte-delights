...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <br />
    <div align="center">
      <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" BackColor="#DEBA84" BorderColor="#DEBA84" BorderStyle="None" BorderWidth="1px" CellPadding="3" CellSpacing="2" DataSourceID="SqlDataSource3" DataKeyNames="id">
        ...
        <asp:Button ID="Button1" class="btn btn-primary py-1" Height="30px" runat="server"  Text="Cash on Delivery" OnClick="Button1_Click1" />
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    <asp:Button ID="Button2" class="btn btn-primary py-1" Height="30px" runat="server" Text="Online Payment" OnClick="Button2_Click" />    
    </div>
    <br />
    </asp:Content>
